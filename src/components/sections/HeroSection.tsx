    ...
    <section className="relative flex-1 flex flex-col justify-center px-[24px] md:px-[30px] pt-[80px] pb-[20px] overflow-hidden">
      ...
      <div className="z-10 w-full max-w-[1400px] mx-auto my-auto relative">
        <h1 
          ...
          className="text-[58px] sm:text-[80px] md:text-[104px] lg:text-[116px] leading-[0.82] tracking-[1px] uppercase text-(--color-ink) max-w-[900px] mb-[36px] md:mb-[52px] font-normal drop-shadow-xs"
        >
